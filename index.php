...
cursor: url("usr/lib/cursors/arrow_r.cur"), default;
}
...
z-index:200;
cursor: url("usr/lib/cursors/wait_r.cur"), wait;
}
...
.fenetre a {
color:blue;
cursor: url("usr/lib/cursors/link_r.cur"), default;
}
</style>
   </head>
...
<div class="dock" id="dock2" style="display:none">
  ...
  <a class="dock-item2" onclick="creer_fenetre(100,100,270,80,'RSS','http://www.rss-image.com/img/3c5b6ec4de20dad5271e3618ada7be1d.gif')" href="#"><span>RSS</span><img src="usr/img/rss.png" alt="RSS" /></a> 
  <a class="dock-item2" onclick="creer_fenetre(100,100,400,40,'RSS 2','http://www.rss-image.com/img/6078b847ecccdb3d672ce91d143d87a3.gif')" href="#"><span>RSS2</span><img src="usr/img/rss2.png" alt="RSS 2" /></a> 
